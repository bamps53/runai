...
def run(epochs, batch_size, lr, gpus, data_augmentation, cpu_relocation, cpu_merge):
    ...
    if gpus > 1:
        # https://github.com/keras-team/keras/blob/2.2.4/keras/utils/multi_gpu_utils.py#L147
        # with _get_available_devices_hook(['/cpu:0','/gpu:0','/gpu:1']), _normalize_device_name_hook(): # this is to support multi-gpu on a machine w/o GPUs
    ...
    if not data_augmentation:
        ...
        # with open("blabla.txt", "w") as f:
        #     f.write(str(K.get_session().graph.as_graph_def()))
